...
public class MetroDAO {
	...
	public boolean fermateCollegate(Fermata f1, Fermata f2) {
		String sql = "SELECT COUNT(*) AS cnt FROM connessione WHERE (id_stazP=? AND id_stazA=?) OR (id_stazP=? AND id_stazA=?)";
	...
	public List<Connessione> getAllConnessioni(List<Fermata> fermate) {
		String sql = "SELECT id_connessione, id_linea, id_stazP, id_stazA FROM connessione WHERE id_stazP>id_stazA";
